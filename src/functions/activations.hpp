...
public:
    virtual bool elements_non_interdependent() const = 0;
...
public:
    virtual bool elements_non_interdependent() const override {return true;}
...
public:
    virtual bool elements_non_interdependent() const override {return false;}
